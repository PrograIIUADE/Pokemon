...
public interface PokedexTDA {
	...
	ColaTDA OrdenarPokemones(TipoPokemon tipo, Caracteristica carac);
	ColaPrioridadTDA<Pokemon> PokemonesPoderosos(int cant);
	ColaPrioridadTDA<Pokemon> PokemonesDebiles(int cant);
